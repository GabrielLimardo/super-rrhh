<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('last') }}
            {{ Form::text('last', $paymentHistory->last, ['class' => 'form-control' . ($errors->has('last') ? ' is-invalid' : ''), 'placeholder' => 'Last']) }}
            {!! $errors->first('last', '<div class="invalid-feedback">:message</div>') !!}
        </div>
