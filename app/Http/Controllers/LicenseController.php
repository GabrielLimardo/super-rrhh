...
class LicenseController extends Controller
{
    ...
    //TODO codigo para borrar
    // public function createLicense(Request $request)
    // {
    //     // request()->validate(LicenseType::$rules);
    ...
    // // Redirect to the license types index page
    // return redirect()->route('license-types.index')->with('success', 'License type and flows created successfully');
    }
}
